...
<div class="container">
  ...
  <table align="center" class="infoTable">
   ...
   <tr>
    ...
    <td class="content">${result.requiredCredits}&nbsp;/&nbsp;${result.passedCredits}
       [#if result.owedCredits>0]
        <span style="color:red">缺${result.owedCredits}分</span>
        [#if result.owedCredits!=result.owedCredits3](在读课程通过后，[#if result.owedCredits3>0]<span style="color:red">缺${result.owedCredits3}分</span>[#else]可完成计划[/#if])[/#if]
       [/#if]
    </td>
